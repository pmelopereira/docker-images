...
# Set up BEA Home
BEA_HOME="/u01/oracle/weblogic"

# Set up Middleware Home
MW_HOME="/u01/oracle/weblogic"
...
MODULES_DIR="/u01/oracle/weblogic/modules"

# Set up Common Features Directory
FEATURES_DIR="/u01/oracle/weblogic/modules/features"
...
if [ "$PRODUCTION_MODE" = "true" ]; then
  ...
  HP)
    JAVA_VM=-server
    MEM_ARGS="-Xms512m -Xmx2048m -XX:MaxPermSize=512m"
  ;;
  IBM)
    JAVA_VM=
    MEM_ARGS="-Xms512m -Xmx2048m"
